...
import { UserInfo, AppDispatch } from "../types/types";
        ...
        <div className="d-flex flex-column bd-highlight mb-3">
          ...
          <div className="mb-3">
            ...
            <input
              ...
              {...register("birthDate", {
                required: "please inter birth date",
              })}
              onChange={(e) =>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              onChange={(e) =>
                setFormValue({ ...formValue, nationalId: e.target.value })
              }
            />
            {errors.nationalId && (
          ...
          <div className="mb-3">
            ...
            <input
              ...
              onChange={(e) =>
                setFormValue({ ...formValue, profile: e.target.value })
              }
            />
            {errors.profile && (
